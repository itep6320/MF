...
if ($response === false) {
    echo json_encode(['success' => false, 'error' => 'Erreur lors de la récupération des données OMDb']);
    exit;
}
...
// Extraire l'année (format: "2011–2019" ou "2011–")
$annee = null;
if (!empty($data['Year'])) {
